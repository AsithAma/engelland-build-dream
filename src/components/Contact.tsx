                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        onChange={handleChange}
                        className="w-full px-3 sm:px-4 py-2 sm:py-3 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#041f99] focus:border-transparent transition-all duration-300 text-sm sm:text-base appearance-none bg-white text-gray-900"
                      >
                      ...
                      <svg className="pointer-events-none absolute right-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-[#041f99]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
